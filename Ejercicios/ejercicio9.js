...
carrito.push({producto: "Monitor",
    precio: 800000,
    cantidad: 1
});

console.log('Cantidad del tercer producto:', carrito[3].producto);

let total = carrito[0].precio * carrito[0].cantidad + carrito[1].precio * carrito[1].cantidad + carrito[2].precio * carrito[2].cantidad + carrito[3].precio * carrito[3].cantidad;
